...
tape( 'the function computes the hyperbolic cosecant', function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function computes the hyperbolic cosecant (large negative)', function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function computes the hyperbolic cosecant (large positive)', function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function computes the hyperbolic cosecant (tiny negative)', function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function computes the hyperbolic cosecant (tiny positive)', function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function returns `+0.0` if provided a value greater than `~710.476`', function test( t ) {
	var y;
	var v;
	var i;
...
tape( 'the function returns `-0.0` if provided a value less than `~-709.0896`', function test( t ) {
	var y;
	var v;
	var i;
