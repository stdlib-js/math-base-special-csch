...
tape( 'main export is a function', opts, function test( t ) {
	...
	t.strictEqual( typeof csch, 'function', 'main export is a function' );
	t.end();
});

tape( 'the function computes the hyperbolic cosecant', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function computes the hyperbolic cosecant (large negative)', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function computes the hyperbolic cosecant (large positive)', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function computes the hyperbolic cosecant (tiny negative)', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function computes the hyperbolic cosecant (tiny positive)', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function returns `+0.0` if provided a value greater than `~710.476`', opts, function test( t ) {
	var y;
	var v;
	var i;
...
tape( 'the function returns `-0.0` if provided a value less than `~-709.0896`', opts, function test( t ) {
	var y;
	var v;
	var i;
